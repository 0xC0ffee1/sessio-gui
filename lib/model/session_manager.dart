...
class SessionManager extends ChangeNotifier{
  ...
  void createSession(BuildContext context, SessionData data, SessioTerminalState? state){
    final future = Provider.of<GrpcService>(context, listen: false).newSession(data, state);
    final sessionState = SessionState(sessionData: data, sessionId: data.sessionId, terminalState: state);
  ...
  void reconnectSession(BuildContext context, String sessionId){
    ...
    final future = Provider.of<GrpcService>(context, listen: false).newSession(data!, sessionState?.terminalState);
