...
class ClientIPCClient extends $grpc.Client {
  ...
  static final _$checkSettingsValidity =
      $grpc.ClientMethod<$0.SettingCheckRequest, $0.SettingCheckResponse>(
          '/clientipc.ClientIPC/CheckSettingsValidity',
          ($0.SettingCheckRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.SettingCheckResponse.fromBuffer(value));
  static final _$startCoordinator = $grpc.ClientMethod<
          $0.CoordinatorStartRequest, $0.CoordinatorStartResponse>(
      '/clientipc.ClientIPC/StartCoordinator',
      ($0.CoordinatorStartRequest value) => value.writeToBuffer(),
      ($core.List<$core.int> value) =>
          $0.CoordinatorStartResponse.fromBuffer(value));
  ...
  static final _$getNatFilterType =
      $grpc.ClientMethod<$0.NatFilterRequest, $0.NatFilterResponse>(
          '/clientipc.ClientIPC/GetNatFilterType',
          ($0.NatFilterRequest value) => value.writeToBuffer(),
          ($core.List<$core.int> value) =>
              $0.NatFilterResponse.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.SettingCheckResponse> checkSettingsValidity(
      $0.SettingCheckRequest request,
      {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$checkSettingsValidity, request, options: options);
  }

  $grpc.ResponseFuture<$0.CoordinatorStartResponse> startCoordinator(
      $0.CoordinatorStartRequest request,
      {$grpc.CallOptions? options}) {
  ...
  $grpc.ResponseFuture<$0.NatFilterResponse> getNatFilterType(
      $0.NatFilterRequest request,
      {$grpc.CallOptions? options}) {
...
abstract class ClientIPCServiceBase extends $grpc.Service {
  ...
  ClientIPCServiceBase() {
    ...
    $addMethod($grpc.ServiceMethod<$0.Msg, $0.Msg>(
        ...
        ($0.Msg value) => value.writeToBuffer()));
    $addMethod(
        $grpc.ServiceMethod<$0.SettingCheckRequest, $0.SettingCheckResponse>(
            'CheckSettingsValidity',
            checkSettingsValidity_Pre,
            false,
            false,
            ($core.List<$core.int> value) =>
                $0.SettingCheckRequest.fromBuffer(value),
            ($0.SettingCheckResponse value) => value.writeToBuffer()));
    $addMethod($grpc.ServiceMethod<$0.CoordinatorStartRequest,
            $0.CoordinatorStartResponse>(
        'StartCoordinator',
        startCoordinator_Pre,
        false,
        false,
        ($core.List<$core.int> value) =>
            $0.CoordinatorStartRequest.fromBuffer(value),
  ...
  $async.Future<$0.SettingCheckResponse> checkSettingsValidity_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.SettingCheckRequest> request) async {
    return checkSettingsValidity(call, await request);
  }

  $async.Future<$0.CoordinatorStartResponse> startCoordinator_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.CoordinatorStartRequest> request) async {
  ...
  $async.Future<$0.NatFilterResponse> getNatFilterType_Pre(
      $grpc.ServiceCall call,
      $async.Future<$0.NatFilterRequest> request) async {
  ...
  $async.Future<$0.SettingCheckResponse> checkSettingsValidity(
      $grpc.ServiceCall call, $0.SettingCheckRequest request);
  $async.Future<$0.CoordinatorStartResponse> startCoordinator(
      $grpc.ServiceCall call, $0.CoordinatorStartRequest request);
  $async.Future<$0.LocalPortForwardResponse> localPortForward(
      $grpc.ServiceCall call, $0.SessionData request);
  $async.Future<$0.NatFilterResponse> getNatFilterType(
      $grpc.ServiceCall call, $0.NatFilterRequest request);
...
class ClientEventServiceClient extends $grpc.Client {
  static final _$subscribe =
      $grpc.ClientMethod<$0.SubscribeRequest, $0.ClientEvent>(
  ...
  $grpc.ResponseStream<$0.ClientEvent> subscribe($0.SubscribeRequest request,
      {$grpc.CallOptions? options}) {
    return $createStreamingCall(
...
abstract class ClientEventServiceBase extends $grpc.Service {
  ...
  $async.Stream<$0.ClientEvent> subscribe_Pre($grpc.ServiceCall call,
      $async.Future<$0.SubscribeRequest> request) async* {
    yield* subscribe(call, await request);
  }

  $async.Stream<$0.ClientEvent> subscribe(
