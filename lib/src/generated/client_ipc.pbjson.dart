...
@$core.Deprecated('Use natFilterTypeDescriptor instead')
const NatFilterType$json = {
  '1': 'NatFilterType',
  '2': [
    {'1': 'ENDPOINT_INDEPENDENT', '2': 0},
    {'1': 'ADDRESS_DEPENDENT', '2': 1},
    {'1': 'ADDRESS_AND_PORT_DEPENDENT', '2': 2},
    {'1': 'UNKNOWN', '2': 3},
  ],
};

/// Descriptor for `NatFilterType`. Decode as a `google.protobuf.EnumDescriptorProto`.
...
/// Descriptor for `FileDelData`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fileDelDataDescriptor = $convert.base64Decode(
    'CgtGaWxlRGVsRGF0YRISCgRwYXRoGAEgASgJUgRwYXRoEhUKBmlzX2RpchgCIAEoCFIFaXNEaX'
    'I=');
...
const FileDeleteRequest$json = {
  ...
  '2': [
    ...
    {'1': 'data', '3': 2, '4': 3, '5': 11, '6': '.clientipc.FileDelData', '10': 'data'},
  ],
};
...
final $typed_data.Uint8List fileDeleteRequestDescriptor = $convert.base64Decode(
    'ChFGaWxlRGVsZXRlUmVxdWVzdBIdCgpzZXNzaW9uX2lkGAEgASgJUglzZXNzaW9uSWQSKgoEZG'
    'F0YRgCIAMoCzIWLmNsaWVudGlwYy5GaWxlRGVsRGF0YVIEZGF0YQ==');
...
final $typed_data.Uint8List fileDeleteResponseDescriptor = $convert.base64Decode(
    'ChJGaWxlRGVsZXRlUmVzcG9uc2U=');

@$core.Deprecated('Use fileRenameRequestDescriptor instead')
const FileRenameRequest$json = {
  '1': 'FileRenameRequest',
  '2': [
    {'1': 'session_id', '3': 1, '4': 1, '5': 9, '10': 'sessionId'},
...
/// Descriptor for `FileRenameRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fileRenameRequestDescriptor = $convert.base64Decode(
    'ChFGaWxlUmVuYW1lUmVxdWVzdBIdCgpzZXNzaW9uX2lkGAEgASgJUglzZXNzaW9uSWQSGQoIb2'
    'xkX3BhdGgYAiABKAlSB29sZFBhdGgSGQoIbmV3X3BhdGgYAyABKAlSB25ld1BhdGg=');

@$core.Deprecated('Use fileRenameResponseDescriptor instead')
const FileRenameResponse$json = {
  '1': 'FileRenameResponse',
};

/// Descriptor for `FileRenameResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List fileRenameResponseDescriptor = $convert.base64Decode(
    'ChJGaWxlUmVuYW1lUmVzcG9uc2U=');

@$core.Deprecated('Use coordinatorStartRequestDescriptor instead')
const CoordinatorStartRequest$json = {
  '1': 'CoordinatorStartRequest',
};

/// Descriptor for `CoordinatorStartRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List coordinatorStartRequestDescriptor = $convert.base64Decode(
    'ChdDb29yZGluYXRvclN0YXJ0UmVxdWVzdA==');

@$core.Deprecated('Use coordinatorStartResponseDescriptor instead')
const CoordinatorStartResponse$json = {
  '1': 'CoordinatorStartResponse',
  '2': [
    {'1': 'started', '3': 1, '4': 1, '5': 8, '10': 'started'},
  ],
};

/// Descriptor for `CoordinatorStartResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List coordinatorStartResponseDescriptor = $convert.base64Decode(
    'ChhDb29yZGluYXRvclN0YXJ0UmVzcG9uc2USGAoHc3RhcnRlZBgBIAEoCFIHc3RhcnRlZA==');

@$core.Deprecated('Use settingCheckRequestDescriptor instead')
const SettingCheckRequest$json = {
  '1': 'SettingCheckRequest',
};

/// Descriptor for `SettingCheckRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List settingCheckRequestDescriptor = $convert.base64Decode(
    'ChNTZXR0aW5nQ2hlY2tSZXF1ZXN0');

@$core.Deprecated('Use settingCheckResponseDescriptor instead')
const SettingCheckResponse$json = {
  '1': 'SettingCheckResponse',
  '2': [
    {'1': 'valid', '3': 1, '4': 1, '5': 8, '10': 'valid'},
  ],
};

/// Descriptor for `SettingCheckResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List settingCheckResponseDescriptor = $convert.base64Decode(
    'ChRTZXR0aW5nQ2hlY2tSZXNwb25zZRIUCgV2YWxpZBgBIAEoCFIFdmFsaWQ=');
...
const ClientEvent$json = {
  '1': 'ClientEvent',
  '2': [
    {'1': 'close', '3': 1, '4': 1, '5': 11, '6': '.clientipc.ClientEvent.CloseEvent', '9': 0, '10': 'close'},
  ],
  '3': [ClientEvent_CloseEvent$json, ClientEvent_ServerMigrateEvent$json],
  '4': [ClientEvent_StreamType$json],
  '8': [
    {'1': 'kind'},
  ],
};
...
@$core.Deprecated('Use clientEventDescriptor instead')
const ClientEvent_CloseEvent$json = {
  '1': 'CloseEvent',
  '2': [
    {'1': 'stream_type', '3': 1, '4': 1, '5': 14, '6': '.clientipc.ClientEvent.StreamType', '10': 'streamType'},
    {'1': 'close_reason', '3': 2, '4': 1, '5': 9, '10': 'closeReason'},
    {'1': 'id', '3': 3, '4': 1, '5': 9, '10': 'id'},
  ],
};

@$core.Deprecated('Use clientEventDescriptor instead')
const ClientEvent_ServerMigrateEvent$json = {
  '1': 'ServerMigrateEvent',
  '2': [
    {'1': 'conn_id', '3': 1, '4': 1, '5': 9, '10': 'connId'},
    {'1': 'new_ip', '3': 2, '4': 1, '5': 9, '10': 'newIp'},
  ],
};

@$core.Deprecated('Use clientEventDescriptor instead')
const ClientEvent_StreamType$json = {
  '1': 'StreamType',
  '2': [
    {'1': 'TRANSPORT', '2': 0},
    {'1': 'SESSION', '2': 1},
...
final $typed_data.Uint8List clientEventDescriptor = $convert.base64Decode(
    'CgtDbGllbnRFdmVudBI5CgVjbG9zZRgBIAEoCzIhLmNsaWVudGlwYy5DbGllbnRFdmVudC5DbG'
    '9zZUV2ZW50SABSBWNsb3NlGoMBCgpDbG9zZUV2ZW50EkIKC3N0cmVhbV90eXBlGAEgASgOMiEu'
    'Y2xpZW50aXBjLkNsaWVudEV2ZW50LlN0cmVhbVR5cGVSCnN0cmVhbVR5cGUSIQoMY2xvc2Vfcm'
    'Vhc29uGAIgASgJUgtjbG9zZVJlYXNvbhIOCgJpZBgDIAEoCVICaWQaRAoSU2VydmVyTWlncmF0'
    'ZUV2ZW50EhcKB2Nvbm5faWQYASABKAlSBmNvbm5JZBIVCgZuZXdfaXAYAiABKAlSBW5ld0lwIj'
    'UKClN0cmVhbVR5cGUSDQoJVFJBTlNQT1JUEAASCwoHU0VTU0lPThABEgsKB0NIQU5ORUwQAkIG'
    'CgRraW5k');

@$core.Deprecated('Use natFilterRequestDescriptor instead')
const NatFilterRequest$json = {
  '1': 'NatFilterRequest',
};

/// Descriptor for `NatFilterRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List natFilterRequestDescriptor = $convert.base64Decode(
    'ChBOYXRGaWx0ZXJSZXF1ZXN0');

@$core.Deprecated('Use natFilterResponseDescriptor instead')
const NatFilterResponse$json = {
  '1': 'NatFilterResponse',
  '2': [
    {'1': 'type', '3': 1, '4': 1, '5': 14, '6': '.clientipc.NatFilterType', '10': 'type'},
  ],
};

/// Descriptor for `NatFilterResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List natFilterResponseDescriptor = $convert.base64Decode(
    'ChFOYXRGaWx0ZXJSZXNwb25zZRIsCgR0eXBlGAEgASgOMhguY2xpZW50aXBjLk5hdEZpbHRlcl'
    'R5cGVSBHR5cGU=');
...
const SessionMap$json = {
  '1': 'SessionMap',
  '2': [
    {'1': 'map', '3': 1, '4': 3, '5': 11, '6': '.clientipc.SessionMap.MapEntry', '10': 'map'},
    {'1': 'parents', '3': 2, '4': 3, '5': 11, '6': '.clientipc.SessionMap.ParentsEntry', '10': 'parents'},
  ],
...
const SessionMap_MapEntry$json = {
  ...
  '2': [
    ...
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.clientipc.SessionData', '10': 'value'},
  ],
  '7': {'7': true},
};
...
const SessionMap_ParentsEntry$json = {
  ...
  '2': [
    {'1': 'key', '3': 1, '4': 1, '5': 9, '10': 'key'},
    {'1': 'value', '3': 2, '4': 1, '5': 11, '6': '.clientipc.DeviceStatus', '10': 'value'},
  ],
  '7': {'7': true},
};
...
const SessionData$json = {
  '1': 'SessionData',
  '2': [
    {'1': 'pty', '3': 1, '4': 1, '5': 11, '6': '.clientipc.SessionData.PTYSession', '9': 0, '10': 'pty'},
    {'1': 'sftp', '3': 2, '4': 1, '5': 11, '6': '.clientipc.SessionData.SFTPSession', '9': 0, '10': 'sftp'},
    {'1': 'lpf', '3': 3, '4': 1, '5': 11, '6': '.clientipc.SessionData.LPFSession', '9': 0, '10': 'lpf'},
    {'1': 'session_id', '3': 4, '4': 1, '5': 9, '9': 1, '10': 'sessionId', '17': true},
    {'1': 'username', '3': 5, '4': 1, '5': 9, '10': 'username'},
    {'1': 'device_id', '3': 6, '4': 1, '5': 9, '10': 'deviceId'},
  ],
  '3': [SessionData_PTYSession$json, SessionData_SFTPSession$json, SessionData_LPFSession$json],
  '8': [
    {'1': 'kind'},
    {'1': '_session_id'},
  ],
...
final $typed_data.Uint8List sessionDataDescriptor = $convert.base64Decode(
    ...
    'ZTZXNzaW9uSABSA2xwZhIiCgpzZXNzaW9uX2lkGAQgASgJSAFSCXNlc3Npb25JZIgBARIaCgh1'
    'c2VybmFtZRgFIAEoCVIIdXNlcm5hbWUSGwoJZGV2aWNlX2lkGAYgASgJUghkZXZpY2VJZBoMCg'
    'pQVFlTZXNzaW9uGg0KC1NGVFBTZXNzaW9uGowBCgpMUEZTZXNzaW9uEh0KCmxvY2FsX2hvc3QY'
    'ASABKAlSCWxvY2FsSG9zdBIdCgpsb2NhbF9wb3J0GAIgASgNUglsb2NhbFBvcnQSHwoLcmVtb3'
    'RlX2hvc3QYAyABKAlSCnJlbW90ZUhvc3QSHwoLcmVtb3RlX3BvcnQYBCABKA1SCnJlbW90ZVBv'
    'cnRCBgoEa2luZEINCgtfc2Vzc2lvbl9pZA==');
...
const NewSessionRequest$json = {
  ...
  '2': [
    ...
    {'1': 'session_data', '3': 5, '4': 1, '5': 11, '6': '.clientipc.SessionData', '10': 'sessionData'},
  ],
};
